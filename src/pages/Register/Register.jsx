                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <input name="password" type="password"  className="bg-white border border-gray-300 w-full text-sm px-4 py-2 rounded outline-blue-500" placeholder="Enter password"
