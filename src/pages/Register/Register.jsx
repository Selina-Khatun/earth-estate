                ...
                <div className="max-w-md w-full mx-auto relative z-40">
                    ...
                    <div className="border border-gray-300 animate__animated animate__backInUp bg-white rounded-md p-8">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <div className="">
                                <button type="submit" className="w-full btn   py-3 px-4 text-sm font-semibold rounded text-white bg-gradient-to-r from-cyan-400 to-sky-800 shadow-lg  hover:bg-cyan-600">
                                    Create an account
                                </button>
                            </div>
